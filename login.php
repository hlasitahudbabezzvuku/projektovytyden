    ...
    <div class="w-full max-w-lg p-6 fade-in flex flex-col justify-center">
      ...
      <?php } elseif (array_key_exists("mode", $_GET) && $_GET["mode"] == "host") { ?>
        ...
        <div class="mb-4">
          ...
          <img src="https://api.qrserver.com/v1/create-qr-code/?data=<?php echo urlencode('https://pubz.infinityfreeapp.com/login.php?game=' . $code) ?>" alt="QR kód" class="w-3/4 h-auto object-contain bg-white p-1 rounded"/>
        </div>
        <div class="mb-4">
        ...
        <script>
          ...
          function get_players() { fetch('https://pubz.infinityfreeapp.com/api/get-players.php?game=' + <?php echo $code ?>)
